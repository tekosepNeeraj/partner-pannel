...
class User extends BaseController
{
    ...
    {
        $this->global['pageTitle'] = 'Partner : Dashboard';
        $data['totalEnquiry'] = $this->task_model->taskListingCount();
        $data['userRecords'] = $this->user_model->userListingCount();
    ...
    function userListing()
    {
        ...
        {        
            ...
            $this->global['pageTitle'] = 'SMS Manager : User Listing';
    ...
    function addNew()
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'SMS Manager : Add New User';
    ...
    function editOld($userId = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'SMS Manager : Edit User';
    ...
    {
        $this->global['pageTitle'] = 'SMS Manager : 404 - Page Not Found';
    ...
    function loginHistoy($userId = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'SMS Manager : User Login History';
    ...
    function profile($active = "details")
    {
        ...
        $this->global['pageTitle'] = $active == "details" ? 'SMS Manager : My Profile' : 'SMS Manager : Change Password';
