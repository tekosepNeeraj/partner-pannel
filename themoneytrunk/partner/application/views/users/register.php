    ...
    <div class="login-box">
      ...
      <div class="login-box-body">
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
          <form action="<?php echo base_url(); ?>partner-registration" method="post">
          ...
          <div class="form-group has-feedback">
            <input type="text" class="form-control" placeholder="Pancard" name="pancard" required />
          ...
          <div class="row">
            <div class="col-xs-8">    
             <div class="checkbox icheck">
                <label>
                  <input type="checkbox"> Accept Term & Condition
                </label>
              </div>                      
            </div><!-- /.col -->
            <div class="col-xs-4">
